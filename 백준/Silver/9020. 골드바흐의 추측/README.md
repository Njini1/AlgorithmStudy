...
- 어렵지는 않았으나 에라토스테네스의 체 코드를 또 참고함.
...
- 에라토스테네스의 체로 소수를 구함
- 골드바흐 파티션 중 소수의 차이가 가장 작은 것을 구하는 것이므로 value의 중간값부터 하나씩 구함. 2개의 소수의 합이 짝수 value 이므로 left, rigth를 사용해서 하나는 +1을 하고 하나는 -1을 하면서 소수인지 아닌 지 확인하면서 결과값 찾음.
...
### 노션 링크
https://www.notion.so/9020-214e550432f480079144fc67b5ea4969
